...
def send_message():
    ...
    encrypted_message = encrypt_message(message, 3)  # Shift Cipher Encryption
...
# ✅ Fetch Messages (retrieve chat history)
...
def get_messages(username):
    ...
    chat_history = [{
        "sender": msg[0],
        "receiver": msg[1],
        "message": decrypt_message(msg[2], 3),  # Decrypt before sending
        "timestamp": msg[3]
    } for msg in messages]
